...
session.execCommandSet = function (wrapper, callback) {
    ...
    if (valid !== true && valid !== undefined) {
        if (_.isFunction(valid.then)) {
            return valid.then(function (data) {
                if (data !== true && data !== undefined) {
                    onCompletion(wrapper, data || null);
                    return self;
                }
                session.handleCommand(wrapper, commandInstance, onCompletion);
                return self;
            }).catch(function () {
...
session.handleCommand = function (wrapper, commandInstance, onCompletion) {
    var res;
